...
namespace Project858.Web
{
    ...
    /// </summary>
    public sealed class BinderNullableDateTimeIso8601 : DefaultModelBinder
    {
        ...
        {
            DateTime date;
            return DateTime.TryParse(value.AttemptedValue, null, DateTimeStyles.RoundtripKind, out date) ? date : null as DateTime?;
        }
        #endregion
    }
}
