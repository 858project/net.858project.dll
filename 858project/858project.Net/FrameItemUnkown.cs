...
namespace Project858.Net
{
    ...
    public sealed class FrameItemUnkown : FrameItemBase<List<Byte>>
    {
        ...
        public FrameItemUnkown(UInt32 address, List<Byte> value)
            : base(address, value)
        {
        ...
        public FrameItemUnkown(UInt32 address, Byte[] data)
            : base(address, data)
        {
        ...
        /// Item type
        /// </summary>
        public override FrameItemTypes ItemType { get { return FrameItemTypes.Unkown; } }
        #endregion
