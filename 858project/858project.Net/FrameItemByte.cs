...
namespace Project858.Net
{
    ...
    public sealed class FrameItemByte : FrameItemBase<Byte>
    {
        ...
        public FrameItemByte(UInt32 address, Byte value)
            : base(address, value)
        {
        ...
        public FrameItemByte(UInt32 address, Byte[] data)
            : base(address, data)
        {
        ...
        /// Item type
        /// </summary>
        public override FrameItemTypes ItemType { get { return FrameItemTypes.Byte; } }
        #endregion
