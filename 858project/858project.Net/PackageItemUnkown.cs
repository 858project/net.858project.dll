...
namespace Project858.Net
{
    ...
    /// </summary>
    public sealed class PackageItemUnkown : FrameItemBase<List<Byte>>
    {
        #region - Constructors -
        /// <summary>
        ...
        public PackageItemUnkown(UInt32 address, Byte[] data)
            : base(address, data)
        {
        ...
        /// Item type
        /// </summary>
        public override PackageItemTypes ItemType { get { return PackageItemTypes.Unkown; } }
        #endregion
