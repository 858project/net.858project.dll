...
namespace Project858.Net
{
    ...
    public sealed class FrameItemBoolean : FrameItemBase<Boolean>
    {
        ...
        public FrameItemBoolean(UInt32 address, Boolean value)
            : base(address, value)
        {
        ...
        public FrameItemBoolean(UInt32 address, Byte[] data)
            : base(address, data)
        {
        ...
        /// Item type
        /// </summary>
        public override FrameItemTypes ItemType { get { return FrameItemTypes.Boolean; } }
        #endregion
