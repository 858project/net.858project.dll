...
namespace Project858.Net
{
    ...
    /// </summary>
    public sealed class FrameItemString : FrameItemBase<String>
    {
        #region - Constructors -
        /// <summary>
        ...
        public FrameItemString(UInt32 address, String value)
            : base(address, value)
        {
        ...
        public FrameItemString(UInt32 address, Byte[] data)
            : base(address, data)
        {
        ...
        /// Item type
        /// </summary>
        public override FrameItemTypes ItemType { get { return FrameItemTypes.String; } }
        #endregion
